...
async def post_inserir(
    ...
    produto = Produto(nome=nome,desc=desc,valor=valor,quant=quant,fornecedor=fornecedor)  
...
async def post_alterar(
    ...
    ProdutoRepo.alterar(Produto(id_produto,nome,desc,valor,quant,fornecedor))
